            ...
            match NODE_type(p) {
                ND::Text(n) => match n {
                    ...
                    TextNode::Ins => {
                        ...
                        print_cstr(b"; split(");
                        print_spec(p_ins.split_top_ptr(), b"");
                        print_char(',' as i32);
            ...
            match ND::from(MEM[p].b16.s1) {
                ND::Text(n) => match n {
                    ...
                    TextNode::Glue => {
                        ...
                        let mut g_spec = GlueSpec(g);
                        if let Some(_rc) = g_spec.rc().opt() {
                            g_spec.rc_dec();
                        } else {
                            free_node(g, 4);
                        }
        ...
        if is_char_node(Some(p)) {
            ...
            match text_NODE_type(p).confuse(b"copying") {
                ...
                TextNode::Glue => {
                    ...
                    GlueSpec(*GLUE_NODE_glue_ptr(p) as usize).rc_inc();
    ...
    unsafe fn lab49(t: ValLevel, n: i32, q: usize, i: usize) {
        let p = if t == ValLevel::Mark {
            ...
            let p = if t == ValLevel::Int || t == ValLevel::Dimen {
                ...
                if t <= ValLevel::Mu {
                    MEM[p + 1].b32.s1 = 0;
                    GlueSpec(0).rc_inc(); // TODO: looks like a BUG
                } else {
                    MEM[p + 1].b32.s1 = None.tex_int();
                }
                p
        ...
        match current_block {
            11492179201936201469 => {
                ...
                let q = if NODE_type(p as usize) == TextNode::Kern.into() {
                    ...
                    let mut q = GlueSpec(*GLUE_NODE_glue_ptr(p as usize) as usize); /*:1011 */
                    ...
                    if q.shrink_order() != GlueOrder::Normal && q.shrink() != 0 {
                        ...
                        error();
                        let r = new_spec(q.ptr());
                        GlueSpec(r).set_shrink_order(GlueOrder::Normal);
