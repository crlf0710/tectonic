...
pub(crate) unsafe fn do_register_command(mut a: small_number) {
    ...
    if (p as i32) < 2i32 {
        ...
        if e {
            ...
            geq_define(l as usize, 119_u16, cur_val);
        } else {
            eq_define(l as usize, 119_u16, cur_val);
        }
    };
}
