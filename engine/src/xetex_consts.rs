...
pub(crate) const LAST_PENALTY_CODE: u8 = 0;
pub(crate) const LAST_KERN_CODE: u8 = 1;
pub(crate) const LAST_SKIP_CODE: u8 = 2;
pub(crate) const LAST_NODE_TYPE_CODE: u8 = 3;
pub(crate) const INPUT_LINE_NO_CODE: u8 = 4;
pub(crate) const BADNESS_CODE: u8 = 5;
pub(crate) const ETEX_VERSION_CODE: u8 = 6;
pub(crate) const CURRENT_GROUP_LEVEL_CODE: u8 = 7;
pub(crate) const CURRENT_GROUP_TYPE_CODE: u8 = 8;
pub(crate) const CURRENT_IF_LEVEL_CODE: u8 = 9;
pub(crate) const CURRENT_IF_TYPE_CODE: u8 = 10;
pub(crate) const CURRENT_IF_BRANCH_CODE: u8 = 11;
pub(crate) const GLUE_STRETCH_ORDER_CODE: u8 = 12;
pub(crate) const GLUE_SHRINK_ORDER_CODE: u8 = 13;
pub(crate) const XETEX_VERSION_CODE: u8 = 14;
pub(crate) const XETEX_COUNT_GLYPHS_CODE: u8 = 15;
pub(crate) const XETEX_COUNT_VARIATIONS_CODE: u8 = 16;
pub(crate) const XETEX_VARIATION_CODE: u8 = 17;
pub(crate) const XETEX_FIND_VARIATION_BY_NAME_CODE: u8 = 18;
pub(crate) const XETEX_VARIATION_MIN_CODE: u8 = 19;
pub(crate) const XETEX_VARIATION_MAX_CODE: u8 = 20;
pub(crate) const XETEX_VARIATION_DEFAULT_CODE: u8 = 21;
pub(crate) const XETEX_COUNT_FEATURES_CODE: u8 = 22;
pub(crate) const XETEX_FEATURE_CODE_CODE: u8 = 23;
pub(crate) const XETEX_FIND_FEATURE_BY_NAME_CODE: u8 = 24;
pub(crate) const XETEX_IS_EXCLUSIVE_FEATURE_CODE: u8 = 25;
pub(crate) const XETEX_COUNT_SELECTORS_CODE: u8 = 26;
pub(crate) const XETEX_SELECTOR_CODE_CODE: u8 = 27;
pub(crate) const XETEX_FIND_SELECTOR_BY_NAME_CODE: u8 = 28;
pub(crate) const XETEX_IS_DEFAULT_SELECTOR_CODE: u8 = 29;
pub(crate) const XETEX_OT_COUNT_SCRIPTS_CODE: u8 = 30;
pub(crate) const XETEX_OT_COUNT_LANGUAGES_CODE: u8 = 31;
pub(crate) const XETEX_OT_COUNT_FEATURES_CODE: u8 = 32;
pub(crate) const XETEX_OT_SCRIPT_CODE: u8 = 33;
pub(crate) const XETEX_OT_LANGUAGE_CODE: u8 = 34;
pub(crate) const XETEX_OT_FEATURE_CODE: u8 = 35;
pub(crate) const XETEX_MAP_CHAR_TO_GLYPH_CODE: u8 = 36;
pub(crate) const XETEX_GLYPH_INDEX_CODE: u8 = 37;
pub(crate) const XETEX_FONT_TYPE_CODE: u8 = 38;
pub(crate) const XETEX_FIRST_CHAR_CODE: u8 = 39;
pub(crate) const XETEX_LAST_CHAR_CODE: u8 = 40;
pub(crate) const PDF_LAST_X_POS_CODE: u8 = 41;
pub(crate) const PDF_LAST_Y_POS_CODE: u8 = 42;
pub(crate) const PDF_SHELL_ESCAPE_CODE: u8 = 45;
pub(crate) const XETEX_PDF_PAGE_COUNT_CODE: u8 = 46;
pub(crate) const XETEX_GLYPH_BOUNDS_CODE: u8 = 47;
pub(crate) const FONT_CHAR_WD_CODE: u8 = 48;
pub(crate) const FONT_CHAR_HT_CODE: u8 = 49;
pub(crate) const FONT_CHAR_DP_CODE: u8 = 50;
pub(crate) const FONT_CHAR_IC_CODE: u8 = 51;
pub(crate) const PAR_SHAPE_LENGTH_CODE: u8 = 52;
pub(crate) const PAR_SHAPE_INDENT_CODE: u8 = 53;
pub(crate) const PAR_SHAPE_DIMEN_CODE: u8 = 54;
pub(crate) const GLUE_STRETCH_CODE: u8 = 55;
pub(crate) const GLUE_SHRINK_CODE: u8 = 56;
pub(crate) const MU_TO_GLUE_CODE: u8 = 57; // ETEX_GLUE
pub(crate) const GLUE_TO_MU_CODE: u8 = 58; // ETEX_MU
pub(crate) const ETEX_EXPR_INT: u8 = 59;
pub(crate) const ETEX_EXPR_DIMEN: u8 = 60;
pub(crate) const ETEX_EXPR_GLUE: u8 = 61;
pub(crate) const ETEX_EXPR_MU: u8 = 62;
