...
unsafe fn scan_cdef<R: Read>(
    ...
    let mut opacity_channels: i32 = 0; /* Cn */
    let mut have_type0: i32 = 0; /* must be 0 for SMask */
    *smask = 0;
    ...
    if opacity_channels == 1 {
        *smask = if have_type0 != 0 { 1 } else { 0 }
