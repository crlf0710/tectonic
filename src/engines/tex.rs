...
impl TexEngine {
    ...
    pub fn process(
        ...
        unsafe {
            super::tt_xetex_set_int_variable("in_initex_mode", v);
        }
        let v = if self.synctex_enabled { 1 } else { 0 };
        unsafe {
            super::tt_xetex_set_int_variable("synctex_enabled", v);
        }
        ...
        unsafe {
            super::tt_xetex_set_int_variable("semantic_pagination_enabled", v);
        }
